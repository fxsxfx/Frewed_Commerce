...
class Ventana(Frame):
    ...
    def widgets(self):
        ...
        Button(self.frame_titulo, text='REGRESAR', font = ('Arial', 9, 'bold'), command=salir_invetario, fg='black', bg = 'deep sky blue', width=20, bd=3).grid(column=0, row=0, pady=5)
        Label(self.frame_titulo, text= 'Inventario', bg='#FFD961', fg='black', font=('Kaufmann BT', 25, 'bold')).grid(columnspan=5, column=0, row=1)
        ...
        Label(self.frame_uno, text= 'CantidadI', bg='#FFD961', fg='black', font=('Rockwell', 13, 'bold')).grid(column=0, row=2, pady=5)
        ...
        Label(self.frame_uno, text= 'Proveedor', bg='#FFD961', fg='black', font=('Rockwell', 13, 'bold')).grid(column=0, row=5, pady=5)
        ...
        Entry(self.frame_uno, textvariable=self.cantidadI , font=('Comic Sans MS', 12), highlightbackground="black", highlightthickness=1).grid(column=1, row=2)
        Entry(self.frame_uno, textvariable=self.proveedor , font=('Comic Sans MS', 12), highlightbackground="black", highlightthickness=1).grid(column=1, row=5)
    ...
    def obtener_fila(self,event):
        ...
        self.cantidad.set(self.data['values'][0])
